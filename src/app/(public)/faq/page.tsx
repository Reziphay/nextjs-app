    ...
    <main className="mx-auto max-w-[1240px] px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      ...
      <form className="mt-10">
        <input
          ...
          className="h-14 w-full rounded-[20px] border border-transparent bg-[var(--color-surface)] px-5 text-sm text-[var(--color-ink)] outline-none transition focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary-soft)]"
        />
      </form>
      <div className="mt-10">
