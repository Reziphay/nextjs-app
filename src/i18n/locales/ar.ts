...
export const arMessages: Messages = {
  ...
  brands: {
    ...
    socialSection: "وسائل التواصل الاجتماعي والموقع",
    ...
    socialAddLink: "إضافة رابط",
    socialRemoveLink: "إزالة الرابط",
    socialUrlErrorInvalidFormat: "صيغة URL غير صحيحة",
    socialUrlErrorInvalidProtocol: "يجب أن يبدأ URL بـ https:// أو http://",
    socialUrlErrorTooLong: "URL طويل جداً (الحد الأقصى 500 حرف)",
    socialUrlErrorInvalidChars: "URL يحتوي على أحرف غير صالحة",
  },
  profile: {
    ...enMessages.profile,
    title: "ملفي الشخصي",
